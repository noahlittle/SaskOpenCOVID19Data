...
### Important Data Note
Case data in this dataset includes out-of-province residents who tested positive for COVID-19 while in Saskatchewan. As such, the total is 10 cases higher than the official count, which recently removed non-resident cases.
